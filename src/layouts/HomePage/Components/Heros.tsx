                        ...
                        <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                            <div className='ml-2'>
                                ...
                                <p className='lead'>
                                    ...
                                    learn a new skill or grow within one, we will be able to provide the top content for
                                    you !
                                </p>
                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='mt-2'>
                            ...
                            <p className='lead'>
                                ...
                                and our book selection and our books are always going to be our top priority.
                            </p>
                        </div>
                    </div>
                    <div className='col-sm-6 col-md-6'>
